...
#define SPEEDMOD_DISABLE_PRINTK //SpeedMod: Disable printk output if defined
...
{
#ifndef SPEEDMOD_DISABLE_PRINTK //SpeedMod: Disable printk
	va_list args;
	int r;
